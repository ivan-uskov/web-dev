      ...
      <div class="form_line select_box">
        <div class="text_input_box select_year_box">
          <select name="year" id="year">
            {foreach from=$years item=yearName key="yearVal"}
              <option value="{$yearVal}">{$yearName}</option>
            {/foreach}
        ...
        <div class="text_input_box select_day_box">
          <select name="day" id="day">
            {foreach from=$days item=dayName key="dayVal"}
              <option value="{$dayVal}">{$dayName}</option>
            {/foreach}
        ...
        <div class="text_input_box select_month_box">
          <select name="month" id="month">
            {foreach from=$months item=monthName key="monthVal"}
              <option value="{$monthVal}">{$monthName}</option>
            {/foreach}
